 ...
 */
export default memoize(function (containerWidth, itemsDimensions, _a) {
    var gutterPixels = _a.gutterPixels, layout = _a.layout;
    ...
    switch (layout) {
        ...
        case LAYOUT.SAME_HEIGHT:
            return makeSameHeightLayoutPositions(containerWidth, itemsDimensions, gutterPixels);
        case LAYOUT.SAME_WIDTH:
            return makeSameWidthLayoutPositions(containerWidth, itemsDimensions, gutterPixels);
        case LAYOUT.PACKED:
            return makePackedLayoutPositions(containerWidth, itemsDimensions, gutterPixels);
        case LAYOUT.SAME_SIZE:
        default:
            return makeSameSizeLayoutPosition(containerWidth, itemsDimensions, gutterPixels);
    }
});
//# sourceMappingURL=makeLayoutPositions.js.map