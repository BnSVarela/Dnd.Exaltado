...
var Animator = /** @class */ (function () {
    ...
    Animator.animate = function (node, targetStyles) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Animator.process({
                            node: node,
    ...
    Animator.process = function (transition) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) {
                        transition.eventReceiver.on('transitionend', function () {
